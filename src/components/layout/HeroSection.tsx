    ...
    <section className="relative overflow-hidden bg-[#ffc928] text-[#211715] py-10 md:py-16 px-4 md:px-8 border-b border-[#f5a80c]/40 shadow-inner">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/40 backdrop-blur-sm border border-white/50 text-xs font-black uppercase tracking-wider text-[#651015] mb-6 shadow-sm">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-[#b91520] tracking-tight leading-[1.08] mb-6">
            {headline}
          </h1>

          {/* Subtitle (Matching Image 1) */}
          <p className="text-base sm:text-lg md:text-xl font-semibold text-[#651015]/85 leading-relaxed mb-8 max-w-2xl">
            {t('orderFromBranchDesc')}
          </p>

          {/* Slogan & Actions (Matching Image 1) */}
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pt-4 border-t border-[#651015]/15">
            ...
            <div className="flex items-center gap-3">
              {branch ? (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-full font-bold text-sm bg-[#651015] text-white hover:bg-[#b91520] shadow-lg shadow-red-950/20 transition-all cursor-pointer"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full font-black text-sm bg-[#b91520] text-white hover:bg-[#651015] shadow-xl shadow-red-950/30 transition-all cursor-pointer animate-pulse hover:animate-none"
                >
                  <Store size={18} />
                  {t('selectBranch')}
                  <ArrowDown size={16} />
