...
export function Header({ onChangeBranch }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between gap-3 px-4 md:px-8 py-3 bg-[rgba(255,248,234,0.95)] backdrop-blur-lg border-b border-[rgba(33,23,21,0.13)]">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          className="h-10 px-4 rounded-full font-bold text-[#651015] bg-white border border-[rgba(33,23,21,0.13)] hover:bg-gray-50 transition-colors text-sm whitespace-nowrap"
        >
          {t('switchLang')}
        </button>
      </div>
